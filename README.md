[Clique aqui]( onlinephp.io/c/f77ec) para testar o código online.
...
2. Criei um array com os 31 valores e verifico por meio da função in_array se o número selecionado está na função. (Como já foi feita a verificação anteriormente esse if sempre resultará positivo, mas por conta do desafio pedir essa verificação, assim o fiz).
